...
namespace GlfwNet.Core
{
    public unsafe static class Glfw
    {
        ...
        {
            return FuncLoader.LoadLibraryExt(RuntimeInformation.IsOSPlatform(OSPlatform.Windows)
                ? LibWindows
                : LibLinux);
        }
        ...
        private static glfwGetMonitorsDelegate _glfwGetMonitors = FuncLoader.LoadFunction<glfwGetMonitorsDelegate>(NativeLibrary, "glfwGetMonitors");
        ...
        private static glfwGetVideoModeDelegate _glfwGetVideoMode = FuncLoader.LoadFunction<glfwGetVideoModeDelegate>(NativeLibrary, "glfwGetVideoMode");
        ...
        private static glfwInitDelegate _glfwInit = FuncLoader.LoadFunction<glfwInitDelegate>(NativeLibrary, "glfwInit");
        public static int glfwInit() => _glfwInit();

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void glfwTerminateDelegate();
        private static glfwTerminateDelegate _glfwTerminate = FuncLoader.LoadFunction<glfwTerminateDelegate>(NativeLibrary, "glfwTerminate");
        public static void glfwTerminate() => _glfwTerminate();

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void glfwInitHintDelegate(int hint, int value);
        private static glfwInitHintDelegate _glfwInitHint = FuncLoader.LoadFunction<glfwInitHintDelegate>(NativeLibrary, "glfwInitHint");
        ...
        private static glfwGetVersionDelegate _glfwGetVersion = FuncLoader.LoadFunction<glfwGetVersionDelegate>(NativeLibrary, "glfwGetVersion");
        ...
        private static glfwGetVersionStringDelegate _glfwGetVersionString = FuncLoader.LoadFunction<glfwGetVersionStringDelegate>(NativeLibrary, "glfwGetVersionString");
        ...
        private static glfwGetErrorDelegate _glfwGetError = FuncLoader.LoadFunction<glfwGetErrorDelegate>(NativeLibrary, "glfwGetError");
        ...
        private static glfwSetErrorCallbackDelegate _glfwSetErrorCallback = FuncLoader.LoadFunction<glfwSetErrorCallbackDelegate>(NativeLibrary, "glfwSetErrorCallback");
        ...
        private static glfwGetPrimaryMonitorDelegate _glfwGetPrimaryMonitor = FuncLoader.LoadFunction<glfwGetPrimaryMonitorDelegate>(NativeLibrary, "glfwGetPrimaryMonitor");
        ...
        private static glfwGetMonitorPosDelegate _glfwGetMonitorPos = FuncLoader.LoadFunction<glfwGetMonitorPosDelegate>(NativeLibrary, "glfwGetMonitorPos");
        ...
        private static glfwGetMonitorWorkareaDelegate _glfwGetMonitorWorkarea = FuncLoader.LoadFunction<glfwGetMonitorWorkareaDelegate>(NativeLibrary, "glfwGetMonitorWorkarea");
        ...
        private static glfwGetMonitorPhysicalSizeDelegate _glfwGetMonitorPhysicalSize = FuncLoader.LoadFunction<glfwGetMonitorPhysicalSizeDelegate>(NativeLibrary, "glfwGetMonitorPhysicalSize");
        ...
        private static glfwGetMonitorContentScaleDelegate _glfwGetMonitorContentScale = FuncLoader.LoadFunction<glfwGetMonitorContentScaleDelegate>(NativeLibrary, "glfwGetMonitorContentScale");
        ...
        private static glfwGetMonitorNameDelegate _glfwGetMonitorName = FuncLoader.LoadFunction<glfwGetMonitorNameDelegate>(NativeLibrary, "glfwGetMonitorName");
        ...
        private static glfwSetMonitorUserPointerDelegate _glfwSetMonitorUserPointer = FuncLoader.LoadFunction<glfwSetMonitorUserPointerDelegate>(NativeLibrary, "glfwSetMonitorUserPointer");
        ...
        private static glfwGetMonitorUserPointerDelegate _glfwGetMonitorUserPointer = FuncLoader.LoadFunction<glfwGetMonitorUserPointerDelegate>(NativeLibrary, "glfwGetMonitorUserPointer");
        ...
        private static glfwSetMonitorCallbackDelegate _glfwSetMonitorCallback = FuncLoader.LoadFunction<glfwSetMonitorCallbackDelegate>(NativeLibrary, "glfwSetMonitorCallback");
        ...
        private static glfwGetVideoModesDelegate _glfwGetVideoModes = FuncLoader.LoadFunction<glfwGetVideoModesDelegate>(NativeLibrary, "glfwGetVideoModes");
        ...
        private static glfwSetGammaDelegate _glfwSetGamma = FuncLoader.LoadFunction<glfwSetGammaDelegate>(NativeLibrary, "glfwSetGamma");
        ...
        private static glfwGetGammaRampDelegate _glfwGetGammaRamp = FuncLoader.LoadFunction<glfwGetGammaRampDelegate>(NativeLibrary, "glfwGetGammaRamp");
        ...
        private static glfwSetGammaRampDelegate _glfwSetGammaRamp = FuncLoader.LoadFunction<glfwSetGammaRampDelegate>(NativeLibrary, "glfwSetGammaRamp");
        ...
        private static glfwDefaultWindowHintsDelegate _glfwDefaultWindowHints = FuncLoader.LoadFunction<glfwDefaultWindowHintsDelegate>(NativeLibrary, "glfwDefaultWindowHints");
        ...
        private static glfwWindowHintDelegate _glfwWindowHint = FuncLoader.LoadFunction<glfwWindowHintDelegate>(NativeLibrary, "glfwWindowHint");
        ...
        private static glfwWindowHintStringDelegate _glfwWindowHintString = FuncLoader.LoadFunction<glfwWindowHintStringDelegate>(NativeLibrary, "glfwWindowHintString");
        ...
        private static glfwCreateWindowDelegate _glfwCreateWindow = FuncLoader.LoadFunction<glfwCreateWindowDelegate>(NativeLibrary, "glfwCreateWindow");
        ...
        private static glfwDestroyWindowDelegate _glfwDestroyWindow = FuncLoader.LoadFunction<glfwDestroyWindowDelegate>(NativeLibrary, "glfwDestroyWindow");
        ...
        private static glfwWindowShouldCloseDelegate _glfwWindowShouldClose = FuncLoader.LoadFunction<glfwWindowShouldCloseDelegate>(NativeLibrary, "glfwWindowShouldClose");
        ...
        private static glfwSetWindowShouldCloseDelegate _glfwSetWindowShouldClose = FuncLoader.LoadFunction<glfwSetWindowShouldCloseDelegate>(NativeLibrary, "glfwSetWindowShouldClose");
        ...
        private static glfwSetWindowTitleDelegate _glfwSetWindowTitle = FuncLoader.LoadFunction<glfwSetWindowTitleDelegate>(NativeLibrary, "glfwSetWindowTitle");
        ...
        private static glfwSetWindowIconDelegate _glfwSetWindowIcon = FuncLoader.LoadFunction<glfwSetWindowIconDelegate>(NativeLibrary, "glfwSetWindowIcon");
        ...
        private static glfwGetWindowPosDelegate _glfwGetWindowPos = FuncLoader.LoadFunction<glfwGetWindowPosDelegate>(NativeLibrary, "glfwGetWindowPos");
        ...
        private static glfwSetWindowPosDelegate _glfwSetWindowPos = FuncLoader.LoadFunction<glfwSetWindowPosDelegate>(NativeLibrary, "glfwSetWindowPos");
        ...
        private static glfwGetWindowSizeDelegate _glfwGetWindowSize = FuncLoader.LoadFunction<glfwGetWindowSizeDelegate>(NativeLibrary, "glfwGetWindowSize");
        ...
        private static glfwSetWindowSizeLimitsDelegate _glfwSetWindowSizeLimits = FuncLoader.LoadFunction<glfwSetWindowSizeLimitsDelegate>(NativeLibrary, "glfwSetWindowSizeLimits");
        ...
        private static glfwSetWindowAspectRatioDelegate _glfwSetWindowAspectRatio = FuncLoader.LoadFunction<glfwSetWindowAspectRatioDelegate>(NativeLibrary, "glfwSetWindowAspectRatio");
        ...
        private static glfwSetWindowSizeDelegate _glfwSetWindowSize = FuncLoader.LoadFunction<glfwSetWindowSizeDelegate>(NativeLibrary, "glfwSetWindowSize");
        ...
        private static glfwGetFramebufferSizeDelegate _glfwGetFramebufferSize = FuncLoader.LoadFunction<glfwGetFramebufferSizeDelegate>(NativeLibrary, "glfwGetFramebufferSize");
        ...
        private static glfwGetWindowFrameSizeDelegate _glfwGetWindowFrameSize = FuncLoader.LoadFunction<glfwGetWindowFrameSizeDelegate>(NativeLibrary, "glfwGetWindowFrameSize");
        ...
        private static glfwGetWindowContentScaleDelegate _glfwGetWindowContentScale = FuncLoader.LoadFunction<glfwGetWindowContentScaleDelegate>(NativeLibrary, "glfwGetWindowContentScale");
        ...
        private static glfwGetWindowOpacityDelegate _glfwGetWindowOpacity = FuncLoader.LoadFunction<glfwGetWindowOpacityDelegate>(NativeLibrary, "glfwGetWindowOpacity");
        ...
        private static glfwSetWindowOpacityDelegate _glfwSetWindowOpacity = FuncLoader.LoadFunction<glfwSetWindowOpacityDelegate>(NativeLibrary, "glfwSetWindowOpacity");
        ...
        private static glfwIconifyWindowDelegate _glfwIconifyWindow = FuncLoader.LoadFunction<glfwIconifyWindowDelegate>(NativeLibrary, "glfwIconifyWindow");
        ...
        private static glfwRestoreWindowDelegate _glfwRestoreWindow = FuncLoader.LoadFunction<glfwRestoreWindowDelegate>(NativeLibrary, "glfwRestoreWindow");
        ...
        private static glfwMaximizeWindowDelegate _glfwMaximizeWindow = FuncLoader.LoadFunction<glfwMaximizeWindowDelegate>(NativeLibrary, "glfwMaximizeWindow");
        ...
        private static glfwShowWindowDelegate _glfwShowWindow = FuncLoader.LoadFunction<glfwShowWindowDelegate>(NativeLibrary, "glfwShowWindow");
        ...
        private static glfwHideWindowDelegate _glfwHideWindow = FuncLoader.LoadFunction<glfwHideWindowDelegate>(NativeLibrary, "glfwHideWindow");
        ...
        private static glfwFocusWindowDelegate _glfwFocusWindow = FuncLoader.LoadFunction<glfwFocusWindowDelegate>(NativeLibrary, "glfwFocusWindow");
        ...
        private static glfwRequestWindowAttentionDelegate _glfwRequestWindowAttention = FuncLoader.LoadFunction<glfwRequestWindowAttentionDelegate>(NativeLibrary, "glfwRequestWindowAttention");
        ...
        private static glfwGetWindowMonitorDelegate _glfwGetWindowMonitor = FuncLoader.LoadFunction<glfwGetWindowMonitorDelegate>(NativeLibrary, "glfwGetWindowMonitor");
        ...
        private static glfwSetWindowMonitorDelegate _glfwSetWindowMonitor = FuncLoader.LoadFunction<glfwSetWindowMonitorDelegate>(NativeLibrary, "glfwSetWindowMonitor");
        ...
        private static glfwGetWindowAttribDelegate _glfwGetWindowAttrib = FuncLoader.LoadFunction<glfwGetWindowAttribDelegate>(NativeLibrary, "glfwGetWindowAttrib");
        ...
        private static glfwSetWindowAttribDelegate _glfwSetWindowAttrib = FuncLoader.LoadFunction<glfwSetWindowAttribDelegate>(NativeLibrary, "glfwSetWindowAttrib");
        ...
        private static glfwSetWindowUserPointerDelegate _glfwSetWindowUserPointer = FuncLoader.LoadFunction<glfwSetWindowUserPointerDelegate>(NativeLibrary, "glfwSetWindowUserPointer");
        ...
        private static glfwGetWindowUserPointerDelegate _glfwGetWindowUserPointer = FuncLoader.LoadFunction<glfwGetWindowUserPointerDelegate>(NativeLibrary, "glfwGetWindowUserPointer");
        ...
        private static glfwSetWindowPosCallbackDelegate _glfwSetWindowPosCallback = FuncLoader.LoadFunction<glfwSetWindowPosCallbackDelegate>(NativeLibrary, "glfwSetWindowPosCallback");
        ...
        private static glfwSetWindowSizeCallbackDelegate _glfwSetWindowSizeCallback = FuncLoader.LoadFunction<glfwSetWindowSizeCallbackDelegate>(NativeLibrary, "glfwSetWindowSizeCallback");
        ...
        private static glfwSetWindowCloseCallbackDelegate _glfwSetWindowCloseCallback = FuncLoader.LoadFunction<glfwSetWindowCloseCallbackDelegate>(NativeLibrary, "glfwSetWindowCloseCallback");
        ...
        private static glfwSetWindowRefreshCallbackDelegate _glfwSetWindowRefreshCallback = FuncLoader.LoadFunction<glfwSetWindowRefreshCallbackDelegate>(NativeLibrary, "glfwSetWindowRefreshCallback");
        ...
        private static glfwSetWindowFocusCallbackDelegate _glfwSetWindowFocusCallback = FuncLoader.LoadFunction<glfwSetWindowFocusCallbackDelegate>(NativeLibrary, "glfwSetWindowFocusCallback");
        ...
        private static glfwSetWindowIconifyCallbackDelegate _glfwSetWindowIconifyCallback = FuncLoader.LoadFunction<glfwSetWindowIconifyCallbackDelegate>(NativeLibrary, "glfwSetWindowIconifyCallback");
        ...
        private static glfwSetWindowMaximizeCallbackDelegate _glfwSetWindowMaximizeCallback = FuncLoader.LoadFunction<glfwSetWindowMaximizeCallbackDelegate>(NativeLibrary, "glfwSetWindowMaximizeCallback");
        ...
        private static glfwSetFramebufferSizeCallbackDelegate _glfwSetFramebufferSizeCallback = FuncLoader.LoadFunction<glfwSetFramebufferSizeCallbackDelegate>(NativeLibrary, "glfwSetFramebufferSizeCallback");
        ...
        private static glfwSetWindowContentScaleCallbackDelegate _glfwSetWindowContentScaleCallback = FuncLoader.LoadFunction<glfwSetWindowContentScaleCallbackDelegate>(NativeLibrary, "glfwSetWindowContentScaleCallback");
        ...
        private static glfwPollEventsDelegate _glfwPollEvents = FuncLoader.LoadFunction<glfwPollEventsDelegate>(NativeLibrary, "glfwPollEvents");
        public static void glfwPollEvents() => _glfwPollEvents();

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void glfwWaitEventsDelegate();
        private static glfwWaitEventsDelegate _glfwWaitEvents = FuncLoader.LoadFunction<glfwWaitEventsDelegate>(NativeLibrary, "glfwWaitEvents");
        public static void glfwWaitEvents() => _glfwWaitEvents();

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void glfwWaitEventsTimeoutDelegate(double timeout);
        private static glfwWaitEventsTimeoutDelegate _glfwWaitEventsTimeout = FuncLoader.LoadFunction<glfwWaitEventsTimeoutDelegate>(NativeLibrary, "glfwWaitEventsTimeout");
        ...
        private static glfwPostEmptyEventDelegate _glfwPostEmptyEvent = FuncLoader.LoadFunction<glfwPostEmptyEventDelegate>(NativeLibrary, "glfwPostEmptyEvent");
        ...
        private static glfwGetInputModeDelegate _glfwGetInputMode = FuncLoader.LoadFunction<glfwGetInputModeDelegate>(NativeLibrary, "glfwGetInputMode");
        ...
        private static glfwSetInputModeDelegate _glfwSetInputMode = FuncLoader.LoadFunction<glfwSetInputModeDelegate>(NativeLibrary, "glfwSetInputMode");
        ...
        private static glfwRawMouseMotionSupportedDelegate _glfwRawMouseMotionSupported = FuncLoader.LoadFunction<glfwRawMouseMotionSupportedDelegate>(NativeLibrary, "glfwRawMouseMotionSupported");
        ...
        private static glfwGetKeyNameDelegate _glfwGetKeyName = FuncLoader.LoadFunction<glfwGetKeyNameDelegate>(NativeLibrary, "glfwGetKeyName");
        ...
        private static glfwGetKeyScancodeDelegate _glfwGetKeyScancode = FuncLoader.LoadFunction<glfwGetKeyScancodeDelegate>(NativeLibrary, "glfwGetKeyScancode");
        ...
        private static glfwGetKeyDelegate _glfwGetKey = FuncLoader.LoadFunction<glfwGetKeyDelegate>(NativeLibrary, "glfwGetKey");
        ...
        private static glfwGetMouseButtonDelegate _glfwGetMouseButton = FuncLoader.LoadFunction<glfwGetMouseButtonDelegate>(NativeLibrary, "glfwGetMouseButton");
        ...
        private static glfwGetCursorPosDelegate _glfwGetCursorPos = FuncLoader.LoadFunction<glfwGetCursorPosDelegate>(NativeLibrary, "glfwGetCursorPos");
        ...
        private static glfwSetCursorPosDelegate _glfwSetCursorPos = FuncLoader.LoadFunction<glfwSetCursorPosDelegate>(NativeLibrary, "glfwSetCursorPos");
        ...
        private static glfwCreateCursorDelegate _glfwCreateCursor = FuncLoader.LoadFunction<glfwCreateCursorDelegate>(NativeLibrary, "glfwCreateCursor");
        ...
        private static glfwCreateStandardCursorDelegate _glfwCreateStandardCursor = FuncLoader.LoadFunction<glfwCreateStandardCursorDelegate>(NativeLibrary, "glfwCreateStandardCursor");
        ...
        private static glfwDestroyCursorDelegate _glfwDestroyCursor = FuncLoader.LoadFunction<glfwDestroyCursorDelegate>(NativeLibrary, "glfwDestroyCursor");
        ...
        private static glfwSetCursorDelegate _glfwSetCursor = FuncLoader.LoadFunction<glfwSetCursorDelegate>(NativeLibrary, "glfwSetCursor");
        ...
        private static glfwSetKeyCallbackDelegate _glfwSetKeyCallback = FuncLoader.LoadFunction<glfwSetKeyCallbackDelegate>(NativeLibrary, "glfwSetKeyCallback");
        ...
        private static glfwSetCharCallbackDelegate _glfwSetCharCallback = FuncLoader.LoadFunction<glfwSetCharCallbackDelegate>(NativeLibrary, "glfwSetCharCallback");
        ...
        private static glfwSetCharModsCallbackDelegate _glfwSetCharModsCallback = FuncLoader.LoadFunction<glfwSetCharModsCallbackDelegate>(NativeLibrary, "glfwSetCharModsCallback");
        ...
        private static glfwSetMouseButtonCallbackDelegate _glfwSetMouseButtonCallback = FuncLoader.LoadFunction<glfwSetMouseButtonCallbackDelegate>(NativeLibrary, "glfwSetMouseButtonCallback");
        ...
        private static glfwSetCursorPosCallbackDelegate _glfwSetCursorPosCallback = FuncLoader.LoadFunction<glfwSetCursorPosCallbackDelegate>(NativeLibrary, "glfwSetCursorPosCallback");
        ...
        private static glfwSetCursorEnterCallbackDelegate _glfwSetCursorEnterCallback = FuncLoader.LoadFunction<glfwSetCursorEnterCallbackDelegate>(NativeLibrary, "glfwSetCursorEnterCallback");
        ...
        private static glfwSetScrollCallbackDelegate _glfwSetScrollCallback = FuncLoader.LoadFunction<glfwSetScrollCallbackDelegate>(NativeLibrary, "glfwSetScrollCallback");
        ...
        private static glfwSetDropCallbackDelegate _glfwSetDropCallback = FuncLoader.LoadFunction<glfwSetDropCallbackDelegate>(NativeLibrary, "glfwSetDropCallback");
        ...
        private static glfwJoystickPresentDelegate _glfwJoystickPresent = FuncLoader.LoadFunction<glfwJoystickPresentDelegate>(NativeLibrary, "glfwJoystickPresent");
        ...
        private static glfwGetJoystickAxesDelegate _glfwGetJoystickAxes = FuncLoader.LoadFunction<glfwGetJoystickAxesDelegate>(NativeLibrary, "glfwGetJoystickAxes");
        ...
        private static glfwGetJoystickButtonsDelegate _glfwGetJoystickButtons = FuncLoader.LoadFunction<glfwGetJoystickButtonsDelegate>(NativeLibrary, "glfwGetJoystickButtons");
        ...
        private static glfwGetJoystickHatsDelegate _glfwGetJoystickHats = FuncLoader.LoadFunction<glfwGetJoystickHatsDelegate>(NativeLibrary, "glfwGetJoystickHats");
        ...
        private static glfwGetJoystickNameDelegate _glfwGetJoystickName = FuncLoader.LoadFunction<glfwGetJoystickNameDelegate>(NativeLibrary, "glfwGetJoystickName");
        ...
        private static glfwGetJoystickGUIDDelegate _glfwGetJoystickGUID = FuncLoader.LoadFunction<glfwGetJoystickGUIDDelegate>(NativeLibrary, "glfwGetJoystickGUID");
        ...
        private static glfwSetJoystickUserPointerDelegate _glfwSetJoystickUserPointer = FuncLoader.LoadFunction<glfwSetJoystickUserPointerDelegate>(NativeLibrary, "glfwSetJoystickUserPointer");
        ...
        private static glfwGetJoystickUserPointerDelegate _glfwGetJoystickUserPointer = FuncLoader.LoadFunction<glfwGetJoystickUserPointerDelegate>(NativeLibrary, "glfwGetJoystickUserPointer");
        ...
        private static glfwJoystickIsGamepadDelegate _glfwJoystickIsGamepad = FuncLoader.LoadFunction<glfwJoystickIsGamepadDelegate>(NativeLibrary, "glfwJoystickIsGamepad");
        ...
        private static glfwSetJoystickCallbackDelegate _glfwSetJoystickCallback = FuncLoader.LoadFunction<glfwSetJoystickCallbackDelegate>(NativeLibrary, "glfwSetJoystickCallback");
        ...
        private static glfwUpdateGamepadMappingsDelegate _glfwUpdateGamepadMappings = FuncLoader.LoadFunction<glfwUpdateGamepadMappingsDelegate>(NativeLibrary, "glfwUpdateGamepadMappings");
        ...
        private static glfwGetGamepadNameDelegate _glfwGetGamepadName = FuncLoader.LoadFunction<glfwGetGamepadNameDelegate>(NativeLibrary, "glfwGetGamepadName");
        ...
        private static glfwGetGamepadStateDelegate _glfwGetGamepadState = FuncLoader.LoadFunction<glfwGetGamepadStateDelegate>(NativeLibrary, "glfwGetGamepadState");
        ...
        private static glfwSetClipboardStringDelegate _glfwSetClipboardString = FuncLoader.LoadFunction<glfwSetClipboardStringDelegate>(NativeLibrary, "glfwSetClipboardString");
        ...
        private static glfwGetClipboardStringDelegate _glfwGetClipboardString = FuncLoader.LoadFunction<glfwGetClipboardStringDelegate>(NativeLibrary, "glfwGetClipboardString");
        ...
        private static glfwGetTimeDelegate _glfwGetTime = FuncLoader.LoadFunction<glfwGetTimeDelegate>(NativeLibrary, "glfwGetTime");
        public static double glfwGetTime() => _glfwGetTime();

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void glfwSetTimeDelegate(double time);
        private static glfwSetTimeDelegate _glfwSetTime = FuncLoader.LoadFunction<glfwSetTimeDelegate>(NativeLibrary, "glfwSetTime");
        public static void glfwSetTime(double time) => _glfwSetTime(time);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate ulong glfwGetTimerValueDelegate();
        private static glfwGetTimerValueDelegate _glfwGetTimerValue = FuncLoader.LoadFunction<glfwGetTimerValueDelegate>(NativeLibrary, "glfwGetTimerValue");
        public static ulong glfwGetTimerValue() => _glfwGetTimerValue();

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate ulong glfwGetTimerFrequencyDelegate();
        private static glfwGetTimerFrequencyDelegate _glfwGetTimerFrequency = FuncLoader.LoadFunction<glfwGetTimerFrequencyDelegate>(NativeLibrary, "glfwGetTimerFrequency");
        ...
        private static glfwMakeContextCurrentDelegate _glfwMakeContextCurrent = FuncLoader.LoadFunction<glfwMakeContextCurrentDelegate>(NativeLibrary, "glfwMakeContextCurrent");
        ...
        private static glfwGetCurrentContextDelegate _glfwGetCurrentContext = FuncLoader.LoadFunction<glfwGetCurrentContextDelegate>(NativeLibrary, "glfwGetCurrentContext");
        ...
        private static glfwSwapBuffersDelegate _glfwSwapBuffers = FuncLoader.LoadFunction<glfwSwapBuffersDelegate>(NativeLibrary, "glfwSwapBuffers");
        ...
        private static glfwSwapIntervalDelegate _glfwSwapInterval = FuncLoader.LoadFunction<glfwSwapIntervalDelegate>(NativeLibrary, "glfwSwapInterval");
        ...
        private static glfwExtensionSupportedDelegate _glfwExtensionSupported = FuncLoader.LoadFunction<glfwExtensionSupportedDelegate>(NativeLibrary, "glfwExtensionSupported");
        ...
        private static glfwGetProcAddressDelegate _glfwGetProcAddress = FuncLoader.LoadFunction<glfwGetProcAddressDelegate>(NativeLibrary, "glfwGetProcAddress");
        ...
        private static glfwVulkanSupportedDelegate _glfwVulkanSupported = FuncLoader.LoadFunction<glfwVulkanSupportedDelegate>(NativeLibrary, "glfwVulkanSupported");
        ...
        private static glfwGetRequiredInstanceExtensionsDelegate _glfwGetRequiredInstanceExtensions = FuncLoader.LoadFunction<glfwGetRequiredInstanceExtensionsDelegate>(NativeLibrary, "glfwGetRequiredInstanceExtensions");
